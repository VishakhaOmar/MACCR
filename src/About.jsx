    ...
    <section>
      <div className="common-page">
        <h2>About Us</h2>
          ...
          Ms. Rimzim Jain, the student of this college (2025 passed out) has been selected in Tata Consultancy Services (TCS for BPO services) through an off campus drive arranged for the students of this college</p>
    </div>
    </section>
  )
}